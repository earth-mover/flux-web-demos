...
async function fetchGfsPointTimeseries(
    ...
    const url = `https://compute.earthmover.io/v1/services/edr/earthmover-demos/gfs/main/timeseries/edr/position?coords=POINT(${point.lng}%20${point.lat})&time=2024-11-04&f=cf_covjson&parameter-name=${variable}`;
